...
const Avatar = forwardRef(
  (
    { startPosition = [0, 0, 0], skateboardRef, isManualCameraMode = false, onAnimationChange },
    ref
  ) => {
    ...
    const { checkSkateProximity, mountSkateboard, dismountSkateboard, handleSkateMovement } =
      useAvatarSkate(
        rigidBodyRef,
        avatarRef,
        rotationRef,
